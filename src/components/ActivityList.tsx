...
export default function ActivityList({ activities, dispatch }: ActivityListProp) {
    ...
    return (
        <>
            ...
            { isEmptyActivities ? 
            <p className="mt-10 text-center">No hay Actividades aún...</p> :
                activities.map(activity => (
                    <div key={activity.id} className="hover:scale-105 transition-all px-5 py-10 bg-slate-50 mt-5 flex justify-between shadow-lg">
